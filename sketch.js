...
function preload(){
      ...
      snitchimg=loadImage("../images/snitch.png");
...
function playLevel3(){
      ...
      keeper.bounceOff(edges[0]);
      keeper.bounceOff(edges[3]);
      harry2.bounceOff(edges[0])
      harry2.bounceOff(edges[1]);
      harry2.bounceOff(edges[2]);
      harry2.bounceOff(edges[3]);
      draco.bounceOff(edges[0]);
      draco.bounceOff(edges[1]);
      draco.bounceOff(edges[2]);
      draco.bounceOff(edges[3]);
      ginny.bounceOff(edges[0]);
      ginny.bounceOff(edges[1]);
      ginny.bounceOff(edges[2]);
      ginny.bounceOff(edges[3]);
      oliverwood.bounceOff(edges[0]);
      oliverwood.bounceOff(edges[1]);
      oliverwood.bounceOff(edges[2]);
      oliverwood.bounceOff(edges[3]);

      
      text("Score=",width-100,height-100,);
      if(house === "griffindor"){
           character="oliverwood";
           oliverwood.visible=true;
      } 
  ...
  else if(buldger.isTouching(pole)){
        score=score+10;
  }
}